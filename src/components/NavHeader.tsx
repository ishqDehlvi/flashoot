...
import { Smartphone, ChevronRight, LogOut, Settings, UserIcon, Menu, X, Home, Newspaper, Lightbulb, DollarSign, Compass, History, Sparkles } from "lucide-react";
...
import flashootLogo from '../images/Flashoot_logo.png';
            ...
            >
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="px-6 py-2 rounded-xl text-lg font-medium bg-gradient-to-br from-[#FE002A] via-[#FE002A] to-[#B3001E] hover:from-[#FE002A]/95 hover:via-[#FE002A]/95 hover:to-[#B3001E]/95 transition-all shadow-[0_2px_12px_-3px_rgba(254,0,42,0.4)]"
                >
